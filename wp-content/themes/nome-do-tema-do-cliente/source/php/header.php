        ...
        <div class="container content-navbar">
            ...
            <div id="bg-menu-mobile">
                <ul>
                    ...
                    <li class="item_nav"><a class="link" href="#sobre">sobre</a></li>
                    <li class="item_nav"><a class="link" href="#">link3</a></li>
                    <li class="item_nav"><a class="link" href="#">link4</a></li>
                    <li class="item_nav"><a class="link" href="#">link5</a></li>
                    <li class="item_nav"><a class="link" href="#">link6</a></li>
