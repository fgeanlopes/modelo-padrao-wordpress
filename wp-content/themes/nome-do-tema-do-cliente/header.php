<!DOCTYPE html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"><title> <?php
    ...
    </nav> --><div class="navbar-master"><div class="container content-navbar"><img class="logo_empresa" src="<?= get_stylesheet_directory_uri() ?>/dist/img/logo_empresa.png"><div id="hamburger"><span></span> <span></span> <span></span></div><div id="bg-menu-mobile"><ul><li class="item_nav"><a class="link" href="#inicio">Ínicio</a></li><li class="item_nav"><a class="link" href="#quem-sou">Quem Sou</a></li><li class="item_nav"><a class="link" href="#graduacoes">Graduações</a></li><li class="item_nav"><a class="link" href="#congresso-e-cursos">Congressos e Cursos</a></li><li class="item_nav"><a class="link" href="#na-midia">Na mídia</a></li><li class="item_nav"><a class="link" href="#contato">Contato</a></li><div class="rede-social-home d-md-none"><a href="<?php the_field('rede-social-1') ?>"><img src="<?= get_stylesheet_directory_uri() ?>/dist/img/facebook.png"> </a><a href="<?php the_field('rede-social-2') ?>"><img src="<?= get_stylesheet_directory_uri() ?>/dist/img/instagram.png"></a></div></ul></div></div></div></header></body></html>